class CalcController {
    ...
    constructor() {
        ...
        this._operation = [];
        this._locale = 'pt-br';
        this._displayCalcEl = document.querySelector("#display");; //O _ antes do nove da variável signifca que este atributo é privado.
    ...
    initialize(){
        ...
        // A cada segundo atualiza a hora da calculadora com segundo e tudo mais.
        setInterval(() => {
